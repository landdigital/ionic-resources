...
var getPlatforms = function () {
  ...
  platforms.push({
    ...
    icons : [
      ...
      { name : 'icon-24@3x.png',    size : 72  },
      { name : 'icon-27.5.png',     size : 27.5},
      { name : 'icon-27.5@2x.png',  size : 55  },
      { name : 'icon-27.5@3x.png',  size : 82.5},
      ...
      { name : 'icon-86@3x.png',    size : 258 },
      { name : 'icon-44@2x.png',    size : 88  },
      { name : 'icon-44@3x.png',    size : 132 },
      ...
      { name : 'icon-98.png',       size : 98 },
      { name : 'icon-98@2x.png',    size : 196 },
      { name : 'icon-98@3x.png',    size : 294 },
